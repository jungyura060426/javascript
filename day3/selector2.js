...
// $("#menu li:first").css("background-color","red"); // [-1] or [배열.length-1]
...
// nth-last-of-type(숫자) 선택자 : 선택한 요소의 무리 중 지정된 숫자의 요소 중에서도 마지막 위치
...
// eq(index) : 선택 요소 중 지정한 인덱스 요소만
// It(index) : 선택 요소 중 지정한 인덱스 보다 작은 요소만
// gt(index) : 선택 요소 중 지정한 인덱스보다 큰 요소만

// $("#menu li").eq(2).css("color", "skyblue");
// $("#menu li:eq(2)").eq(2).css("color", "skyblue"); // [2]번째 요소
...
// only-child : 부모 요소에 단 하나뿐인 자식 요소일 때만
